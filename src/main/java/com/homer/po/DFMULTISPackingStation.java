...
public class DFMULTISPackingStation extends PageBase < DFMULTISPackingStation >  {
	...
	public void MULTISPacking_Station(String PackStationNum,String[] iLPNs1,String ItemNbr, String DistrOrder,String LPNFacility_Status,int OrderQnty) throws Throwable {
