...
public class DFMobilePackingStation   extends PageBase <DFMobilePackingStation> {
	...
	public void Clicks_on_MpbilePackingStation_Link(String PackStationNum) throws Throwable {	        
        ...
        wh.waitForPageLoaded();
        expectedResult = wh.isElementPresent(lnkMobilePackStation);
        if (expectedResult) {
            wh.clickElement(lnkMobilePackStation);
        }
        wh.waitForPageLoaded();
